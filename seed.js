...
async function seed() {
  ...
  // Create users
  await User.create([
    { name: 'Super Admin', email: 'admin@military.gov', password: 'admin123', role: 'admin' },
    { name: 'Col. James Wright', email: 'commander@military.gov', password: 'cmd123', role: 'commander', base: bases[0]._id },
    { name: 'Sgt. Maria Chen', email: 'logistics@military.gov', password: 'log123', role: 'logistics', base: bases[0]._id },
    { name: 'Col. David Kane', email: 'commander2@military.gov', password: 'cmd123', role: 'commander', base: bases[1]._id },
    { name: 'Sgt. Paul Torres', email: 'logistics2@military.gov', password: 'log123', role: 'logistics', base: bases[1]._id },
  ]);
  ...
  console.log('Commander: commander@military.gov / cmd123');
  console.log('Logistics: logistics@military.gov / log123');
